...
import 'package:hyfy/screens/gAuthUpdateAbountScreen.dart';

import '../utilitys/constants.dart';
import '../utilitys/localStorage.dart';
import 'updateAboutScreen.dart';
                        ...
                        if (response.statusCode == 200) {
                          ...
                          if (jsonDecode(response.body)['data']
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => GAuthUpdateAboutScreen(),
                              ),
                            );
                          } else {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => UpdateAboutScreen(),
                              ),
                            );
                          }
                        } else {
